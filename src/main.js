...
router.afterEach(function(to) {
  let baseTitle =
    " - Bilibili.DOG - B站历史数据统计分析站点 - 哔哩哔哩数据查询";
...
Vue.prototype.$baseKeywords =
  "B站,b站数据统计,b站数据分析,bilibili排行榜,哔哩哔哩up主,up主排行,数据,观测者,视频,见齐,biliob,bilibili,UP主,粉丝数,粉丝数排行榜,数据可视化,哔哩哔哩,哔哩哔哩观测者,哔哩哔哩ob,bilibiliob,Bilibili.DOG,BiliBiliDOG,bilibilidog,datadog,data,dog,哔哩哔哩,哔哩哔哩狗";
// 使用axios
